...
typedef enum {
  ...
  SCREEN_SETTINGS_CONNECTIVITY_BLE,
  SCREEN_SETTINGS_NETWORK_INTERNET,
  SCREEN_SETTINGS_NETWORK_INTERNET_WIFI,
  SCREEN_SETTINGS_NETWORK_INTERNET_WIFI_PASSWORD,
  SCREEN_SETTINGS_NETWORK_INTERNET_GPRS,
  SCREEN_SETTINGS_DISPLAY,
  SCREEN_SETTINGS_THEMES,
  SCREEN_SETTINGS_THEMES_WALLPAPERS,
